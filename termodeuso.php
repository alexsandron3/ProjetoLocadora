...
<html lang="pt-br">
    ...
    <body>
        <div id="pagina">
            ...
            <br> </br>
            <h1>Termos de Uso</h1>
            <h3>Startups de tecnologia e sites utilizam frequentemente a figura do termo de uso para que os usuários/clientes possam usufruir de seus serviços. Trata-se de um documento que traz em seu texto as condições e regras para que um usuário do site ou app possa utilizar o serviço que está sendo oferecido</h3>
            <br> </br>
            <br> </br>
            <br> </br>
            <div class="footer">
