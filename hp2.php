        ...
        <figure>
            <figcaption> <h3><strong>Harry Potter e a Ordem da Fênix</strong></h3></figcaption>
                <div class="informacoes_filme">
                    ...
                    <p>Ano: 2007</p>
                    <p>Sinopse: Harry Potter (Daniel Radcliffe) retorna à Escola de Magia e Bruxaria de 
                        Hogwarts, para cursar o 5º ano letivo. Logo ele descobre que boa parte da comunidade
                        bruxa foi levada a acreditar que o retorno de Voldemort (Ralph Fiennes) foi uma 
                        mentira inventada por Harry, o que põe sua credibilidade em dúvida. Além disto,
                        o Ministro da Magia Cornélio Fudge (Robert Hardy) impõe à escola a presença de
                        Dolores Umbridge (Imelda Staunton), que torna-se a nova professora de Defesa 
                        Contra as Artes das Trevas. Acontece que as aulas de Umbridge, apesar de
                        aprovadas pelo ministério, abrangem apenas temas amenos, deixando os alunos
                        despreparados para os perigos dos dias atuais. Incentivado por seus amigos
                        Rony (Rupert Grint) e Hermione (Emma Watson), Harry decide encontrar-se em
                        segredo com um grupo de estudantes, visando a prática de magia. O grupo se 
                        utodenomina como a "Armada de Dumbledore", mas logo passa a ser vista como
                        uma ameaça ao próprio Ministério da Magia..</p> 
                    <div class="btn-local">
                        <li><a href = "FnzCompra.php"><button class="btn_compra">Comprar</button>
                    </div>
                </div>              
                <img class="Capa_FILME" src="Img/IMGHP2.jpg" alt="Harry Potter 2"  > 
        </figure>
        <iframe class="Video_FILME"
        src="https://www.youtube.com/embed/6nzOej8jGgs">
        </iframe>
        <div class="footer">
            <footer>
