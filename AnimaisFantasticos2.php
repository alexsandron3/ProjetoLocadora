...
<html lang="pt-br">
    <head>
        ...
        <title>Animais Fantásticos Os Crimes de Grindelwald</title>
    </head>
    <body>
        <header>
            <nav class="navbar">
            ...
            <br> </br>
            <figure>
                <figcaption> <h3><strong>ANIMAIS FANTÁSTICOS: OS CRIMES DE GRINDELWALD </strong></h3></figcaption>
                    <div class="informacoes_filme">
                        ...
                        <p> Ano: 2018</p>
                        <p> Sinopse: Newt Scamander (Eddie Redmayne) reencontra os queridos amigos
                            Tina Goldstein (Katherine Waterston), Queenie Goldstein (Alison Sudol) 
                            e Jacob Kowalski (Dan Fogler). Ele é recrutado pelo seu antigo professor
                            em Hogwarts, Alvo Dumbledore (Jude Law), para enfrentar o terrível bruxo 
                            das trevas Gellert Grindelwald (Johnny Depp), que escapou da custódia da 
                            MACUSA (Congresso Mágico dos EUA) e reúne seguidores, dividindo o mundo
                            entre seres de magos sangue puro e seres não-mágicos.</p> 
                            <div class="btn-local">
                                <li><a href = "FnzCompra.php"><button class="btn_compra">Comprar</button>
                            </div>
                    </div>              
                    <img class="Capa_FILME" src="img/AF2.jpg" alt="Harry Potter 2"  >   
            </figure>
                <iframe class="Video_FILME"
                src="https://www.youtube.com/embed/orvR_5f9gV4">
                </iframe>
        <div class="footer">
            <footer>
